...
![[Pasted image 20250221164934.png]]
...
option C 
![[Pasted image 20250221164845.png]]Still same, but the best one in my opinion.  1/5 on both sides and an always open menu, allowing the player to always be aware of their stats and making decisions based on all the info. Also the huge spread seems logical for PC build. 
